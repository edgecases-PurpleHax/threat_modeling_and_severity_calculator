    ...
    def get_rating(self):
        ...
        try:
            ...
            self.repudiation = int(
                input("What is the potential damage if identified repudiation attacks occur? "))
            ...
            self.dos = int(
                input("What is the potential service loss if denial of service occurs? "))
    ...
    def get_rating(self):
        ...
        try:
            ...
            if integrity == 3:
                integrity = 5
            availability = int(
                input("What is the impact to availability?\r\n1. None\r\n2. Low\r\n3. High\r\n"))
